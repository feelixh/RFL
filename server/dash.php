...
<?php
$sql = "select r.id, r.rg_aluno, r.cpf, r.imagem, r.ativo, r.tracker, u.NOME_ALUNO from reconhecimento as r inner join unijui as u on u.matr_aluno = r.rg_aluno group by u.NOME_ALUNO;";
